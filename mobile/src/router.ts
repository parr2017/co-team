...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/convo', component: () => import('./views/ConvoListView.vue'), meta: { tab: 'convo' } },
    { path: '/convo/:id', component: () => import('./views/ConvoDetailView.vue'), props: true },
    { path: '/opencode', component: () => import('./views/OpenCodeView.vue') },
    { path: '/opencode/session/:instance/:session', component: () => import('./views/OpenCodeSessionView.vue'), props: true },
