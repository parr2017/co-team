...
- [x] 工作包 C（2026-09-21 完成：P2.3 RAG——embeddings.ts 侧车向量+混合检索、bge-m3 独立向量端点启用并冒烟 dim=1024）
- [x] 工作包 B（2026-09-06 完成：`11c80de` 飞书 bot——webhook 安全入站/命令集/任务卡片动态更新；真机联调待用户提供自建应用凭据与公网可达回调地址）
